$(function() {
	...
	var Page = (function() {
		...
		var config = {
			...
			$folderNext : $( '#folder > div.folder-inner > a#folder-next'),
			$folderClose : $( '#folder > div.folder-inner-next > a#folder-close' ),
			transEndEventNames : {
			...
			initEvents = function() {
				...
				config.$folderNext.on( 'click', function() {
			...
			openFolderNext	= function() {

				var $inner = config.$folder.find( 'div.folder-inner-next' );
			...
			closeFolder	= function() {
				...
				var $fold = config.$folder.find( 'div.folder-fold' ),
						$inner = config.$folder.find( 'div.folder-inner,div.folder-inner-next' ),
						transEndEventName = config.transEndEventNames[ Modernizr.prefixed( 'transition' ) ];
